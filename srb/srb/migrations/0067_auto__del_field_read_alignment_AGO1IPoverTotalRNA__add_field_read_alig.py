...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.AGO1IPoverTotalRNA'
        db.delete_column(u'srb_read_alignment', 'AGO1IPoverTotalRNA')

        # Adding field 'Read_alignment.normRead'
        db.add_column(u'srb_read_alignment', 'normRead',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Read_alignment.AGO1IPoverTotalRNA'
        db.add_column(u'srb_read_alignment', 'AGO1IPoverTotalRNA',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Deleting field 'Read_alignment.normRead'
        db.delete_column(u'srb_read_alignment', 'normRead')
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
            'normRead': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '4'}),
