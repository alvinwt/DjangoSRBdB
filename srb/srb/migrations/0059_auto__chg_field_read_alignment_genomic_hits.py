...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Read_alignment.genomic_hits'
        db.alter_column(u'srb_read_alignment', 'genomic_hits', self.gf('django.db.models.fields.IntegerField')(max_length=45))

    def backwards(self, orm):

        # Changing field 'Read_alignment.genomic_hits'
        db.alter_column(u'srb_read_alignment', 'genomic_hits', self.gf('django.db.models.fields.FloatField')(max_length=45))
