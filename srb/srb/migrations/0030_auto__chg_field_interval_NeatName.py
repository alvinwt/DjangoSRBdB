...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'srb_interval', 'NeatName', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Interval.NeatName'
        db.alter_column(u'srb_interval', 'NeatName', self.gf('django.db.models.fields.CharField')(max_length=45, primary_key=True))
