...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Read_alignment.library_id' to match new field type.
        db.rename_column(u'srb_read_alignment', 'library_id_id', 'library_id')
        # Changing field 'Read_alignment.library_id'
        db.alter_column(u'srb_read_alignment', 'library_id', self.gf('django.db.models.fields.CharField')(max_length=45))
        # Removing index on 'Read_alignment', fields ['library_id']
        db.delete_index(u'srb_read_alignment', ['library_id_id'])


    def backwards(self, orm):
        # Adding index on 'Read_alignment', fields ['library_id']
        db.create_index(u'srb_read_alignment', ['library_id_id'])


        # Renaming column for 'Read_alignment.library_id' to match new field type.
        db.rename_column(u'srb_read_alignment', 'library_id', 'library_id_id')
        # Changing field 'Read_alignment.library_id'
        db.alter_column(u'srb_read_alignment', 'library_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['srb.Library']))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library_id': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
