...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'srb_read_alignment', 'library_name')

        # Adding field 'Read_alignment.library'
        db.add_column(u'srb_read_alignment', 'library',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Read_alignment.library'
        db.delete_column(u'srb_read_alignment', 'library_id')
