...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Read_alignment.stop'
        raise RuntimeError("Cannot reverse this migration. 'Read_alignment.stop' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Read_alignment.start'
        raise RuntimeError("Cannot reverse this migration. 'Read_alignment.start' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Read_alignment.chr'
        raise RuntimeError("Cannot reverse this migration. 'Read_alignment.chr' and its values cannot be restored.")
