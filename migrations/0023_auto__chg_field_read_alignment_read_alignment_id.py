...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'srb_read_alignment', 'read_alignment_id', self.gf('django.db.models.fields.AutoField')(max_length=16, primary_key=True))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            'read_alignment_id': ('django.db.models.fields.AutoField', [], {'max_length': '16', 'primary_key': 'True'}),
