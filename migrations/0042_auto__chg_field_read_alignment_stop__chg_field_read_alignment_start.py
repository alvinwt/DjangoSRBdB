...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Read_alignment.stop'
        db.alter_column(u'srb_read_alignment', 'stop', self.gf('django.db.models.fields.IntegerField')(max_length=45))

        # Changing field 'Read_alignment.start'
        db.alter_column(u'srb_read_alignment', 'start', self.gf('django.db.models.fields.IntegerField')(max_length=45))

    def backwards(self, orm):

        # Changing field 'Read_alignment.stop'
        db.alter_column(u'srb_read_alignment', 'stop', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'Read_alignment.start'
        db.alter_column(u'srb_read_alignment', 'start', self.gf('django.db.models.fields.CharField')(max_length=45))
