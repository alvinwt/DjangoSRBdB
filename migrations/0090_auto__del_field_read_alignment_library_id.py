...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.library_id'
        db.delete_column(u'srb_read_alignment', 'library_id_id')


    def backwards(self, orm):
        # Adding field 'Read_alignment.library_id'
        db.add_column(u'srb_read_alignment', 'library_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['srb.Library']),
                      keep_default=False)
