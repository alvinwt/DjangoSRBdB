...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.mapped_coordinate'
        db.delete_column(u'srb_read_alignment', 'mapped_coordinate_id')

        # Adding field 'Read_alignment.aligned_interval'
        db.add_column(u'srb_read_alignment', 'aligned_interval',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Interval'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Read_alignment.mapped_coordinate'
        db.add_column(u'srb_read_alignment', 'mapped_coordinate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Interval'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            'aligned_interval': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': u"orm['srb.Interval']", 'unique': 'True'}),
