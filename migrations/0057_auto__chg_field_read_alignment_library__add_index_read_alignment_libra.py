...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Read_alignment.library' to match new field type.
        db.rename_column(u'srb_read_alignment', 'library', 'library_id')
        # Changing field 'Read_alignment.library'
        db.alter_column(u'srb_read_alignment', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['srb.Library']))
        # Adding index on 'Read_alignment', fields ['library']
        db.create_index(u'srb_read_alignment', ['library_id'])


    def backwards(self, orm):
        # Removing index on 'Read_alignment', fields ['library']
        db.delete_index(u'srb_read_alignment', ['library_id'])


        # Renaming column for 'Read_alignment.library' to match new field type.
        db.rename_column(u'srb_read_alignment', 'library_id', 'library')
        # Changing field 'Read_alignment.library'
        db.alter_column(u'srb_read_alignment', 'library', self.gf('django.db.models.fields.CharField')(max_length=45))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
