...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'srb_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=15))

    def backwards(self, orm):

        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'srb_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=4))
