...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.Library_name'
        db.add_column(u'srb_read_alignment', 'Library_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Library']),
                      keep_default=False)

        # Deleting field 'Library.id'
        db.delete_column(u'srb_library', u'id')

        # Adding field 'Library.five_prime_adapter_sequence'
        db.add_column(u'srb_library', 'five_prime_adapter_sequence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Library.three_prime_adapter_sequence'
        db.add_column(u'srb_library', 'three_prime_adapter_sequence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # Changing field 'Library.library_id'
        db.alter_column(u'srb_library', 'library_id', self.gf('django.db.models.fields.CharField')(max_length=16, primary_key=True))
        # Adding unique constraint on 'Library', fields ['library_id']
        db.create_unique(u'srb_library', ['library_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Library', fields ['library_id']
        db.delete_unique(u'srb_library', ['library_id'])

        # Deleting field 'Read_alignment.Library_name'
        db.delete_column(u'srb_read_alignment', 'Library_name_id')

        # Adding field 'Library.id'
        db.add_column(u'srb_library', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='', primary_key=True),
                      keep_default=False)

        # Deleting field 'Library.five_prime_adapter_sequence'
        db.delete_column(u'srb_library', 'five_prime_adapter_sequence')

        # Deleting field 'Library.three_prime_adapter_sequence'
        db.delete_column(u'srb_library', 'three_prime_adapter_sequence')


        # Changing field 'Library.library_id'
        db.alter_column(u'srb_library', 'library_id', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            'Library_name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
