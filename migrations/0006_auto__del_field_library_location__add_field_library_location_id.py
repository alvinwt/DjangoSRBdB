...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'srb_library', 'location')

        # Adding field 'Library.location_id'
        db.add_column(u'srb_library', 'location_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['srb.Location'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Library.location_id'
        db.delete_column(u'srb_library', 'location_id_id')
    ...
    models = {
        ...
        u'srb.library': {
            ...
            'location_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Location']", 'null': 'True'}),
