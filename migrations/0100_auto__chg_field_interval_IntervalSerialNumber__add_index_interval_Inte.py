...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'srb_interval', 'IntervalSerialNumber', self.gf('django.db.models.fields.SlugField')(max_length=45))
        # Adding index on 'Interval', fields ['IntervalSerialNumber']
        db.create_index(u'srb_interval', ['IntervalSerialNumber'])
