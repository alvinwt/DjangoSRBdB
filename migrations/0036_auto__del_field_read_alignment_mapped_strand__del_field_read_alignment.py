...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.mapped_strand'
        db.delete_column(u'srb_read_alignment', 'mapped_strand')

        # Deleting field 'Read_alignment.aligned_interval'
        db.delete_column(u'srb_read_alignment', 'aligned_interval_id')

        # Deleting field 'Read_alignment.genome_build_id'
        db.delete_column(u'srb_read_alignment', 'genome_build_id_id')

        # Deleting field 'Read_alignment.seq_run_id'
        db.delete_column(u'srb_read_alignment', 'seq_run_id_id')


    def backwards(self, orm):
        # Adding field 'Read_alignment.mapped_strand'
        db.add_column(u'srb_read_alignment', 'mapped_strand',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45),
                      keep_default=False)

        # Adding field 'Read_alignment.aligned_interval'
        db.add_column(u'srb_read_alignment', 'aligned_interval',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Interval']),
                      keep_default=False)

        # Adding field 'Read_alignment.genome_build_id'
        db.add_column(u'srb_read_alignment', 'genome_build_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Genome_Build']),
                      keep_default=False)

        # Adding field 'Read_alignment.seq_run_id'
        db.add_column(u'srb_read_alignment', 'seq_run_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['srb.Sequencing_Run']),
                      keep_default=False)
