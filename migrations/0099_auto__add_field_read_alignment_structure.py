...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.structure'
        db.add_column(u'srb_read_alignment', 'structure',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Read_alignment.structure'
        db.delete_column(u'srb_read_alignment', 'structure')
