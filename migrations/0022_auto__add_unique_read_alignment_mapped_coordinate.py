...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Read_alignment', fields ['mapped_coordinate']
        db.create_unique(u'srb_read_alignment', ['mapped_coordinate_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Read_alignment', fields ['mapped_coordinate']
        db.delete_unique(u'srb_read_alignment', ['mapped_coordinate_id'])
