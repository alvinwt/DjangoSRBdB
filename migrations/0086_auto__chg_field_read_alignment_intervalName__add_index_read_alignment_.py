...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Read_alignment.intervalName' to match new field type.
        db.rename_column(u'srb_read_alignment', 'intervalName', 'intervalName_id')
        # Changing field 'Read_alignment.intervalName'
        db.alter_column(u'srb_read_alignment', 'intervalName_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['srb.Interval']))
        # Adding index on 'Read_alignment', fields ['intervalName']
        db.create_index(u'srb_read_alignment', ['intervalName_id'])


    def backwards(self, orm):
        # Removing index on 'Read_alignment', fields ['intervalName']
        db.delete_index(u'srb_read_alignment', ['intervalName_id'])


        # Renaming column for 'Read_alignment.intervalName' to match new field type.
        db.rename_column(u'srb_read_alignment', 'intervalName_id', 'intervalName')
        # Changing field 'Read_alignment.intervalName'
        db.alter_column(u'srb_read_alignment', 'intervalName', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intervalName': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Interval']"}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
