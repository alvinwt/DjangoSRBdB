...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.UCSC_GB_mirror'
        db.delete_column(u'srb_location', 'UCSC_GB_mirror')

        # Adding field 'Location.UCSC_mirror'
        db.add_column(u'srb_location', 'UCSC_mirror',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.UCSC_GB_mirror'
        db.add_column(u'srb_location', 'UCSC_GB_mirror',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 7, 31, 0, 0), max_length=45),
                      keep_default=False)

        # Deleting field 'Location.UCSC_mirror'
        db.delete_column(u'srb_location', 'UCSC_mirror')
    ...
    models = {
        ...
        u'srb.library': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Location']", 'blank': 'True'}),
