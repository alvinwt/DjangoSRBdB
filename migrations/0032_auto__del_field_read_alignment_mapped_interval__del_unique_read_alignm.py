...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Read_alignment', fields ['aligned_interval']
        db.delete_unique(u'srb_read_alignment', ['aligned_interval_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Read_alignment', fields ['aligned_interval']
        db.create_unique(u'srb_read_alignment', ['aligned_interval_id'])
