...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.big2catrenormRPmirpre'
        db.add_column(u'srb_read_alignment', 'big2catrenormRPmirpre',
    ...
    def backwards(self, orm):
        # Deleting field 'Read_alignment.big2catrenormRPmirpre'
        db.delete_column(u'srb_read_alignment', 'big2catrenormRPmirpre')
