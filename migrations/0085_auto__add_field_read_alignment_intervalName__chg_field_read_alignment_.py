...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.intervalName'
        db.add_column(u'srb_read_alignment', 'intervalName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


        # Changing field 'Read_alignment.big2catrenormRPmirpre'
        db.alter_column(u'srb_read_alignment', 'big2catrenormRPmirpre', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.AGO1IPoverTotalRNA'
        db.alter_column(u'srb_read_alignment', 'AGO1IPoverTotalRNA', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=15))

    def backwards(self, orm):
        # Deleting field 'Read_alignment.intervalName'
        db.delete_column(u'srb_read_alignment', 'intervalName')


        # Changing field 'Read_alignment.big2catrenormRPmirpre'
        db.alter_column(u'srb_read_alignment', 'big2catrenormRPmirpre', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4))

        # Changing field 'Read_alignment.AGO1IPoverTotalRNA'
        db.alter_column(u'srb_read_alignment', 'AGO1IPoverTotalRNA', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4))
    ...
    models = {
        ...
        u'srb.read_alignment': {
            'AGO1IPoverTotalRNA': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '15', 'blank': 'True'}),
            'Meta': {'object_name': 'Read_alignment'},
            'big2catrenormRPmirpre': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '15', 'blank': 'True'}),
            'chr': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            'genomic_hits': ('django.db.models.fields.IntegerField', [], {'max_length': '45'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intervalName': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
            'normReads': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '15', 'blank': 'True'}),
