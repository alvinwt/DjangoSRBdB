...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.normalizedReads'
        db.add_column(u'srb_read_alignment', 'normalizedReads',
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
            'normalizedReads': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
