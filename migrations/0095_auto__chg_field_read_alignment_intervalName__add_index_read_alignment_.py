...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'srb_read_alignment', 'intervalName_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['srb.Interval']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Read_alignment.intervalName'
        db.alter_column(u'srb_read_alignment', 'intervalName', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
