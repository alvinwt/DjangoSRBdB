...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.read_alignment_id'
        db.delete_column(u'srb_read_alignment', 'read_alignment_id')

        # Adding field 'Read_alignment.id'
        db.add_column(u'srb_read_alignment', u'id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Read_alignment.read_alignment_id'
        raise RuntimeError("Cannot reverse this migration. 'Read_alignment.read_alignment_id' and its values cannot be restored.")
