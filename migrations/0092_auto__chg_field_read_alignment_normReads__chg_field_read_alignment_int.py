...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'srb_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'srb_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.intervalName'
        db.alter_column(u'srb_read_alignment', 'intervalName', self.gf('django.db.models.fields.CharField')(default='', max_length=150))
