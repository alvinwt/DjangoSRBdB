...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Interval', fields ['start', 'chr', 'stop']
        db.create_unique(u'srb_interval', ['start', 'chr', 'stop'])


    def backwards(self, orm):
        # Removing unique constraint on 'Interval', fields ['start', 'chr', 'stop']
        db.delete_unique(u'srb_interval', ['start', 'chr', 'stop'])
