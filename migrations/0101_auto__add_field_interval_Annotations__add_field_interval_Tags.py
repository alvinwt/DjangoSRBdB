...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.Annotations'
        db.add_column(u'srb_interval', 'Annotations',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'Interval.Tags'
        db.add_column(u'srb_interval', 'Tags',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interval.Annotations'
        db.delete_column(u'srb_interval', 'Annotations')

        # Deleting field 'Interval.Tags'
        db.delete_column(u'srb_interval', 'Tags')
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            'structure': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'})
        },
