...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.normCount'
        db.delete_column(u'srb_read_alignment', 'normCount')
    ...
    def backwards(self, orm):
        # Adding field 'Read_alignment.normCount'
        db.add_column(u'srb_read_alignment', 'normCount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'srb.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srb.Library']"}),
            'normRead': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
