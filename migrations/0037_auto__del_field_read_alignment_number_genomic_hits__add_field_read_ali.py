...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Read_alignment.number_genomic_hits'
        db.delete_column(u'srb_read_alignment', 'number_genomic_hits')

        # Adding field 'Read_alignment.genomic_hits'
        db.add_column(u'srb_read_alignment', 'genomic_hits',
                      self.gf('django.db.models.fields.FloatField')(default='', max_length=45),
                      keep_default=False)
        ...
        # Adding field 'Read_alignment.strand'
        db.add_column(u'srb_read_alignment', 'strand',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Read_alignment.number_genomic_hits'
        raise RuntimeError("Cannot reverse this migration. 'Read_alignment.number_genomic_hits' and its values cannot be restored.")
        # Deleting field 'Read_alignment.genomic_hits'
        db.delete_column(u'srb_read_alignment', 'genomic_hits')
        ...
        # Deleting field 'Read_alignment.strand'
        db.delete_column(u'srb_read_alignment', 'strand')
