...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Library.location' to match new field type.
        db.rename_column(u'srb_library', 'location_id', 'location')
        # Changing field 'Library.location'
        db.alter_column(u'srb_library', 'location', self.gf('django.db.models.fields.CharField')(max_length=45))
        # Removing index on 'Library', fields ['location']
        db.delete_index(u'srb_library', ['location_id'])


    def backwards(self, orm):
        # Adding index on 'Library', fields ['location']
        db.create_index(u'srb_library', ['location_id'])


        # Renaming column for 'Library.location' to match new field type.
        db.rename_column(u'srb_library', 'location', 'location_id')
        # Changing field 'Library.location'
        db.alter_column(u'srb_library', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['srb.Location']))
    ...
    models = {
        ...
        u'srb.location': {
            ...
            'UCSC_mirror': ('django.db.models.fields.CharField', [], {'max_length': '45', 'blank': 'True'}),
